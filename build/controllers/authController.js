...
var AuthController = /** @class */ (function () {
    ...
    AuthController.prototype.signin = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, Email, Password, user, token, datosResponse, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (!(Email && Password)) {
                            return [2 /*return*/, res.status(400).json({ value: false, message: 'usuario y contraseña requerido' })];
                        }
                        return [4 /*yield*/, typeorm_1.getRepository(usuario_1.User).findOne({ Email: Email })];
                    case 1:
                        user = _b.sent();
                        if (!user) {
                            return [2 /*return*/, res.status(400).json({ value: false, message: 'correo incorrecto' })];
                        }
                        if (!user.validPassword(Password)) {
                            return [2 /*return*/, res.status(400).json({ value: false, message: 'contraseña incorrecta' })];
                        }
